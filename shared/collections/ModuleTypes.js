...
ActuationUnits 			= new Meteor.Collection("actuationUnits");
SensingUnits			= new Meteor.Collection("sensingUnits");
CommunicationsUnits 	= new Meteor.Collection("communicationsUnits");
EnergyUnits 			= new Meteor.Collection("energyUnits");
